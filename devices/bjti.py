"""
:mod:`bjti` -- Intrinsic Bipolar Transistor
-------------------------------------------
...
class Device(cir.Element):
    ...
    Bulk connection, RC, RE are included in extrinsic model.

    Netlist examples::

        bjti:q1 2 3 4 model = mypnp isat=4e-17 bf=147 vaf=80 ikf=4m

        # Electro-thermal version
        bjti_t:q2 2 3 5 pout gnd model = mypnp

        # Model statement
        .model mypnp bjti_t (type=pnp isat=5e-17 cje=60fF vje=0.83 mje=0.35)
